<?php
class MaDocDepartementCtrl extends AdminCtrl{

    protected $ctrl = __CLASS__;
	protected $page = "mr_departement";
	protected $view = "ma-doc-departement";
	protected $elq = "MrDepartementElq";
    ...
    function listAction($paging = ""){
        ...
        if($keyword = get('keyword')){
            $elq = $elq->like("mdep_name,mdep_desc", $keyword);
        }
        // Get Data
        $data = $elq->paginate();
